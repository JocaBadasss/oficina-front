          ...
          <div className='sm:col-span-1 xl:col-span-2'>
            <div className='bg-DARK_700 rounded-lg p-6 space-y-4'>
              ...
              {loading ? (
                ...
                <>
                  {/* MOBILE CARDS */}
                  <ul className='space-y-4 block md:hidden'>
                    {filtered.map((vehicle) => (
                      <li
                        key={vehicle.id}
                        className='border border-DARK_600 rounded-md bg-DARK_800 p-4 space-y-2'
                      >
                        <p className='text-sm text-LIGHT_500'>
                          <span className='font-semibold text-LIGHT_100'>
                            Placa:
                          </span>{' '}
                          {vehicle.plate}
                        </p>
