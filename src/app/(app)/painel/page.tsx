              ...
              <div className='bg-DARK_700 rounded-lg'>
                <ul className='space-y-2 text-sm p-3 divide-LIGHT_700 divide-y'>
                  <li>
                    <a
                      href='#'
                      className='flex justify-between py-2 hover:bg-DARK_800 px-2 rounded transition cursor-pointer'
                    >
              ...
              <div className='bg-DARK_700 rounded-lg'>
                <ul className='space-y-2 text-sm p-3 divide-LIGHT_700 divide-y text-TINTS_CAKE_200'>
                  <li>
                    <a
                      href='#'
                      className='block py-2 hover:bg-DARK_800 px-2 rounded transition cursor-pointer'
                    >
