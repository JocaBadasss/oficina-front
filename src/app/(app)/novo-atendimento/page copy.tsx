...
export default function NovoAtendimentoPage() {
  ...
  const fullSchema = clientSchema.merge(vehicleSchema).merge(orderSchema);
    ...
    <div className='flex min-h-screen bg-DARK_400 text-LIGHT_100 font-poppins'>
      ...
      <main className='flex-1 p-6 space-y-6'>
        <form
          ...
          className='space-y-6'
        >
          <h1 className='text-3xl font-bold font-roboto'>Novo Atendimento</h1>
          <p className='text-LIGHT_500 mt-1'>
            Cadastre cliente, veículo e ordem de serviço em um só lugar.
          </p>
          {/* Seção CLIENTE */}
